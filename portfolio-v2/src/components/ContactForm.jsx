    ...
    <div className="contact-form" id="email">
      <div className="contact-form__header">
        ...
        <p className="contact-form__sub">
          I'm looking for a place where brand means something. I'd love to hear
          what you're building.<br />日本語でのお問い合わせもお受けいたします。
        </p>
        <div className="contact-form__links">
          ...
          <a
            href="https://www.instagram.com/lilyzvillage.design/"
            target="_blank"
            rel="noopener noreferrer"
            className="contact-form__link"
          >
